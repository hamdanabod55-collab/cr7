                ...
                @forelse($items as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            @if($item->description)
                                <div style="font-size: 0.8rem; color: var(--text-muted); margin-top: 2px;">{{ $item->description }}</div>
                            @endif
                        </td>
                        <td><span style="background: rgba(255,255,255,0.05); padding: 0.2rem 0.5rem; border-radius: 4px; font-size: 0.8rem;">{{ $item->category }}</span></td>
                        ...
                        <td>
                            <div style="display: flex; gap: 0.5rem;">
                                ...
                                <form action="{{ route('items.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Delete item #{{ $item->id }}?')">
                                    @csrf
                                    @method('DELETE')
